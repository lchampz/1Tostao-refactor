...
const Submenu = ({
  ...
  const NextArrow = ({ children }) => {
    return <Arrow onClick={() => slider.current.slideNext()}>{children}</Arrow>;
  };
        ...
        <WrapperHeader>
          ...
          <WrapperFooter>
            <Social>
              {github !== null ? (
                <Row>
                  <ImgWrapper width="1.6rem" height="1.6rem" url={git} />
                  <Text>{github || "@git_name"}</Text>
                </Row>
              ) : null}
              {instagram !== null ? (
                <Row>
                  <ImgWrapper width="1.3rem" height="1.3rem" url={insta} />
                  <Text>{instagram || "@insta_name"}</Text>
                </Row>
              ) : null}
              <Row>
                <ImgWrapper width="1.3rem" height="1.3rem" url={mail} />
                <Text>{email || "mail@mail.com"}</Text>
              </Row>
              {twitter !== null ? (
                <Row>
                  <ImgWrapper width="1.5rem" height="1.5rem" url={tt} />
                  <Text>{twitter || "@twitter_name"}</Text>
                </Row>
              ) : null}
            </Social>
          </WrapperFooter>
